...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398528(v=OCS.15)
ms:contentKeyID: 48184447
ms.date: 07/23/2014
...
Moves one or more user accounts enabled for Lync Server to a new Registrar pool. This cmdlet was introduced in Lync Server 2010.
...
<td><p>URL for the hosted migration service used when moving a user to Lync Online.</p></td>
</tr>
<tr class="even">
