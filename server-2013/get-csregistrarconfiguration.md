...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398483(v=OCS.15)
ms:contentKeyID: 48184360
ms.date: 07/23/2014
...
<td><p>Retrieves the Registrar configuration settings data from the local replica of the Central Management store rather than from the Central Management store itself.</p></td>
</tr>
</tbody>
</table>
