...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ205414(v=OCS.15)
ms:contentKeyID: 48185949
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for which the user services policy being modified. For example:</p>
