...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398180(v=OCS.15)
ms:contentKeyID: 48183407
ms.date: 07/23/2014
...
Creates a new simple URL, which can then be added to a simple URL configuration collection. Simple URLs make it easier for users to join meetings and conferences, and also make it easier for administrators to log on to the Lync Server Control Panel. This cmdlet was introduced in Lync Server 2010.
...
<p>Admin – URL that points to the Lync Server Control Panel.</p>
