...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ205206(v=OCS.15)
ms:contentKeyID: 48185246
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for which the new OAuth server is being created. For example:</p>
