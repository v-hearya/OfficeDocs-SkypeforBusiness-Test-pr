...
<p>Objects in the list must be of type Microsoft.Rtc.Management.WritableConfig.Settings.NetworkConfiguration.BWPolicyType. Objects of this type can be created by calling the <strong>New-CsNetworkBWPolicy</strong> cmdlet and the resulting policy can then be added to the profile by assigning it as the value to this parameter.</p></td>
</tr>
<tr class="even">
