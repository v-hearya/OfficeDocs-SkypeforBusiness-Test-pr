...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ204755(v=OCS.15)
ms:contentKeyID: 48183682
ms.date: 07/23/2014
...
Modifies an existing partner application. A partner application is any application that Lync Online can directly exchange security tokens with, without having to go through a third-party security token server. This cmdlet was introduced in Lync Server 2013.
...
<td><p>Optional</p></td>
<td><p>Guid</p></td>
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for the partner application being modified. For example:</p>
