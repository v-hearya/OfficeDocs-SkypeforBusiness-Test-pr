...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg412830(v=OCS.15)
ms:contentKeyID: 48185135
ms.date: 07/23/2014
...
<td><p>Identity of the service where the audio file is to be imported. (This must be the same service that hosts the Response Group application.) For example: -Identity &quot;service:ApplicationServer:atl-cs-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="even">
