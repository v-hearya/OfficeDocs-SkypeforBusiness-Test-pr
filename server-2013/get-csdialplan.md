...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg413043(v=OCS.15)
ms:contentKeyID: 48185861
ms.date: 07/23/2014
...
<td><p>Retrieves the dial plan information from the local replica of the Central Management store, rather than the Central Management store itself.</p></td>
</tr>
</tbody>
</table>
