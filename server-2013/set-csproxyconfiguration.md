...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg425796(v=OCS.15)
ms:contentKeyID: 48183763
ms.date: 01/12/2017
...
_**Topic Last Modified:** 2017-01-12_
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the Edge Server. The default value is False.</p></td>
</tr>
<tr class="odd">
