...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398818(v=OCS.15)
ms:contentKeyID: 48185382
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for which the new dial-in conferencing access number is being created. For example:</p>
