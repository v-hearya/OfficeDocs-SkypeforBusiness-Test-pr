...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg425761(v=OCS.15)
ms:contentKeyID: 48183699
ms.date: 07/23/2014
...
<td><p>Indicates the valid log file extensions that can be used with the Device Update Web service. This list can be modified; however, there is no reason to modify the list unless you have a device running Lync Server that creates log files that use a different file extension.</p>
