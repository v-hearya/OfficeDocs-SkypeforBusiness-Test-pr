...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ205062(v=OCS.15)
ms:contentKeyID: 48184741
ms.date: 07/23/2014
...
<p>* EmailAddress. The user's email address (as defined in Active Directory) is used as the SIP address.UserPrincipalName. The user's UPN is used as the SIP address.</p>
