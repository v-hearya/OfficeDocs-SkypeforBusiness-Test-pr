...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398876(v=OCS.15)
ms:contentKeyID: 48185392
ms.date: 07/23/2014
...
<p>If this parameter is not included, then the <strong>Set-CsClientVersionPolicy</strong> cmdlet will modify the global policy.</p></td>
</tr>
<tr class="odd">
