...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg412997(v=OCS.15)
ms:contentKeyID: 48185769
ms.date: 07/23/2014
...
Modifies one or more existing client personal identification number (PIN) policies. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. This cmdlet was introduced in Lync Server 2010.
