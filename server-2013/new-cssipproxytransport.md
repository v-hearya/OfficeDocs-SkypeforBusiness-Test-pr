...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398489(v=OCS.15)
ms:contentKeyID: 48184366
ms.date: 07/23/2014
...
Specifies the transmission protocol to be used in a static route. Lync Server enables you to choose either Transmission Control Protocol (TCP) or Transport Layer Security (TLS) as the transmission protocol for a route. This cmdlet was introduced in Lync Server 2010.
