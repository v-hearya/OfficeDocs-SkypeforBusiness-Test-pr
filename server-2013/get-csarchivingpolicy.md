...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg425731(v=OCS.15)
ms:contentKeyID: 48183649
ms.date: 07/23/2014
...
<td><p>Retrieves the archiving policy data from the local replica of the Central Management store rather than from the Central Management store itself.</p></td>
</tr>
</tbody>
</table>
