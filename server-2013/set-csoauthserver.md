...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ204896(v=OCS.15)
ms:contentKeyID: 48184153
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for the OAuth server being modified. For example:</p>
