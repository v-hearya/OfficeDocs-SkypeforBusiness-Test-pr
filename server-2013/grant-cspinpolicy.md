...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398871(v=OCS.15)
ms:contentKeyID: 48185479
ms.date: 07/23/2014
...
Assigns a client personal identification number (PIN) policy to a user or group of users. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. This cmdlet was introduced in Lync Server 2010.
