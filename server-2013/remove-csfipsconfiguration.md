...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ205201(v=OCS.15)
ms:contentKeyID: 48185231
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for the FIPS configuration settings being deleted. For example:</p>
