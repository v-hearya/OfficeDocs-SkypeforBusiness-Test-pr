...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg398065(v=OCS.15)
ms:contentKeyID: 48183220
ms.date: 07/23/2014
...
<td><p>Globally unique identifier (GUID) of the Lync Online tenant account for which the new meeting configuration settings are being created. For example:</p>
