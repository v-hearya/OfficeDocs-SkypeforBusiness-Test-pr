...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Gg412792(v=OCS.15)
ms:contentKeyID: 48185097
ms.date: 07/23/2014
...
<td><p>Retrieves the unassigned number information from the local replica of the Central Management store, rather than the Central Management store itself.</p></td>
</tr>
</tbody>
</table>
